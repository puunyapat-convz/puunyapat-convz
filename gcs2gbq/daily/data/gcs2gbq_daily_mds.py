...
with DAG(
    ...
    start_date=dt.datetime(2022, 6, 27),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'gcs', 'production', 'mario', 'daily_data', 'mds'],
    description='GCS to GBQ for daily MDS data files',
