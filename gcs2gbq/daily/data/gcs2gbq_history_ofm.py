...
DATASET_ID   = "officemate_ofm_historical"
...
with DAG(
    dag_id="gcs2gbq_history_ofm",
    # schedule_interval=None,
    schedule_interval="00 06 * * *",
    start_date=dt.datetime(2022, 5, 3),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'gcs', 'production', 'mario', 'historical', 'officemate'],
    description='GCS to GBQ for daily Officemate historical files',
