...
with DAG(
    ...
    description='GCS to GBQ (DEV) for daily B2S POS/JDA data files',
    ...
    #   'B2S_JDA': ["BCH_JDA_DataPlatform_APADDR", "BCH_JDA_DataPlatform_SETDTL"],
    ...
    with TaskGroup(
        ...
        for source in SUB_FOLDER:
            ...
            DATASET_ID  = f"b2s_{source.lower()}_prod{DS_SUFFIX}"
