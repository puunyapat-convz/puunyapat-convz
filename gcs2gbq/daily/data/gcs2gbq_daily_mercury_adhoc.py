...
with DAG(
    dag_id="gcs2gbq_daily_mercury_adhoc",
    # schedule_interval=None,
    schedule_interval="45 01 * * *",
    start_date=dt.datetime(2021, 12, 26),
    end_date=dt.datetime(2021, 12, 27),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'gcs', 'production', 'mario', 'daily_data', 'mercury'],
    description='GCS to GBQ for daily Mercury data files',
    ...
    # )
    iterable_tables_list = [ "mercury_tborder" ]
