...
DATASET_ID   = "erp_ofm_daily_ctrlfiles"
...
with DAG(
    dag_id="gcs2gbq_daily_erp_ctrl",
    # schedule_interval=None,
    schedule_interval="20 02 * * *",
    start_date=dt.datetime(2022, 4, 28),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'gcs', 'production', 'mario', 'daily_ctrl', 'erp'],
    description='GCS to GBQ for daily ERP control files',
    ...
    # iterable_tables_list = [ "tbshippinglabelinformation", "tbpackingmaster" ]
