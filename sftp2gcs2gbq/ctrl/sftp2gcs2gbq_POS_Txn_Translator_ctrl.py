...
with DAG(
    dag_id="sftp2gcs2gbq_pos_txn_translator_ctrl",
    # schedule_interval=None,
    schedule_interval="50 00 * * *",
    start_date=dt.datetime(2022, 4, 25),
    # end_date=dt.datetime(2022, 5, 24),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'production', 'mario', 'daily_ctrl', 'sftp', 'pos_p2', 'adhoc'],
    ...
    with TaskGroup(
        ...
        for source in MAIN_FOLDER:
            ...
            DATASET_ID  = f"{SUB_FOLDER.lower()}_{source.lower()}_daily_ctrlfiles"
                        ...
                        for interval in [1]:
                            ...
                            with TaskGroup(
                                ...
                                save_gcs   = LocalFilesystemToGCSOperator(
                                    ...
                                    dst = f"{source}/{SUB_FOLDER}/{TABLE_ID}/",
                                    bucket = BUCKET_NAME
                                )
                                ...
                                load_gbq = BigQueryInsertJobOperator( 
                                    ...
                                    configuration = {
                                        "load": {
                                            "sourceUris": [ f'gs://{BUCKET_NAME}/{source}/{SUB_FOLDER}/{TABLE_ID}/*'
