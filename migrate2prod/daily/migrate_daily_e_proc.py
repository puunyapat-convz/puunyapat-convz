...
DATASET_DST  = "e_proc_ofm_daily"
TYPE_DST     = "daily"

PROJECT_SRC  = "central-cto-ofm-data-hub-dev"
DATASET_SRC  = "EProcurement_source"
TYPE_SRC     = "daily"

LOCATION     = "asia-southeast1" 
BUCKET_NAME  = "ofm-data"
SOURCE_NAME  = "E-Procurement"
...
with DAG(
    dag_id="migrate_daily_e_proc",
    schedule_interval=None,
    # schedule_interval="40 00 * * *",
    start_date=dt.datetime(2022, 4, 20),
    catchup=False,
    tags=['convz', 'production', 'migrate', 'daily_data', 'e-procurement', 'mario'],
