...
with DAG(
    ...
    # end_date=dt.datetime(2022, 7, 7),
    catchup=True,
    max_active_runs=1,
    tags=['convz', 'development', 'mario', 'daily_data', 'sftp'],
    description='Test new logic to prevent SFTP timeout',
                    ...
                    with TaskGroup(
                        ...
                        for interval in range:
                            ...
                            save_gcs   = LocalFilesystemToGCSOperator(
                                ...
                                dst = f"test_{MAIN_FOLDER}/{source}/{TABLE_ID}/",
                            ...
                            load_gbq = BigQueryInsertJobOperator( 
                                ...
                                configuration = {
                                    "load": {
                                        ...
                                        "sourceUris": [ f'gs://{BUCKET_NAME}/test_{MAIN_FOLDER}/{source}/{TABLE_ID}/*'
